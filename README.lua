...
local function createTabBtn(name, text, pos)
...
createTabBtn("Dash", "PASSAR", UDim2.new(0.25, 0, 0, 0))
createTabBtn("Follow", "SEGUIR", UDim2.new(0.5, 0, 0, 0))
createTabBtn("Settings", "OPÇÕES", UDim2.new(0.75, 0, 0, 0))
