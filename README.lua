...
ClickSound.SoundId = "rbxassetid://12221967" -- Som de clique padrão do Roblox
...
MinimizeBtn.MouseButton1Click:Connect(function()
    ClickSound:Play() -- Som apenas no botão de minimizar
...
createSlider("Orbit: Velocidade", UDim2.new(0.05, 0, 0, 215), 1, 20, ORBIT_SPEED, function(v) ORBIT_SPEED = v end)
createSlider("Orbit: Distância", UDim2.new(0.05, 0, 0, 255), 2, 50, ORBIT_DISTANCE, function(v) ORBIT_DISTANCE = v end)
createSlider("Altura (Ambos)", UDim2.new(0.05, 0, 0, 295), -10, 20, ORBIT_HEIGHT, function(v) ORBIT_HEIGHT = v; DASH_HEIGHT = v end)

local NameInput = Instance.new("TextBox")
NameInput.Size = UDim2.new(0.9, 0, 0, 35)
NameInput.Position = UDim2.new(0.05, 0, 0, 340)
